...
func NewRedis(ctx *pulumi.Context,
	...
	args.ApiVersion = pulumi.StringPtr("redis.redis.opstreelabs.in/v1beta1")
	...
	var resource Redis
	err := ctx.RegisterResource("kubernetes:redis.redis.opstreelabs.in/v1beta1:Redis", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetRedis(ctx *pulumi.Context,
	...
	var resource Redis
	err := ctx.ReadResource("kubernetes:redis.redis.opstreelabs.in/v1beta1:Redis", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
