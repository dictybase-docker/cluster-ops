...
func NewArangoDeployment(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:database.arangodb.com/v1alpha:ArangoDeployment", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArangoDeployment(ctx *pulumi.Context,
	...
	var resource ArangoDeployment
	err := ctx.ReadResource("kubernetes:database.arangodb.com/v1alpha:ArangoDeployment", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
