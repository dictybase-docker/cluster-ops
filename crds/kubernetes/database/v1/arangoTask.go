...
func NewArangoTask(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:database.arangodb.com/v1:ArangoTask", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArangoTask(ctx *pulumi.Context,
	...
	var resource ArangoTask
	err := ctx.ReadResource("kubernetes:database.arangodb.com/v1:ArangoTask", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
