...
func NewArangoClusterSynchronization(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:database.arangodb.com/v2alpha1:ArangoClusterSynchronization", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArangoClusterSynchronization(ctx *pulumi.Context,
	...
	var resource ArangoClusterSynchronization
	err := ctx.ReadResource("kubernetes:database.arangodb.com/v2alpha1:ArangoClusterSynchronization", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
