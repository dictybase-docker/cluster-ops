...
func NewArangoMember(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("kubernetes:database.arangodb.com/v2alpha1:ArangoMember", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetArangoMember(ctx *pulumi.Context,
	...
	var resource ArangoMember
	err := ctx.ReadResource("kubernetes:database.arangodb.com/v2alpha1:ArangoMember", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
